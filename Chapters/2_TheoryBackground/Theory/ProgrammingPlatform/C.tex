...
C provides a variety of data types and high-level statements such as if-else, switch, while and for. Even though it enables access to memory, it does not provide read/write statements for input and output \cite{cproglang}. \task{Litt mer her kanskje?}