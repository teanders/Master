...
\begin{itemize}
    ...
    \item \textbf{MicroStation} is a \acrshort{cad} software for producing drawings and documentation, developed by Bentley. The software can e.g. be used to make wiring diagrams for embedded systems \cite{microstation}. Version 8.11 is used in this thesis.  
    \item \textbf{nrfGoStudio} is a Windows application, developed by Nordic Semiconductor, which eases development when using the nRFgo Development kit. The software provides a visual editor and provides functionality for configuring and programming nRF51 devices \cite{nrfgo}. 
    ...
    \item \textbf{Microsoft Project} is a project management tool that let the user plan the project progress in detail. It provides information about scheduled workloads for all the participants and helps to keep progress in the project. Through the software, the team can generate useful illustrations like Gantt-diagrams to get a clear presentation of the project development \cite{msproject}.
...
\task{Skriv om resterende programmvare}
...
Also, some extra parts to modify the chassis were made in the schools mechanical workshop.